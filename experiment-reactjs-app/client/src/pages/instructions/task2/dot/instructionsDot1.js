...
const InstructionsDot1 = (props) => {
  ...
  const json = {
    questions: [
      {
        type: "radiogroup",
        name: "Dot_Instruction2",
        title: "In this plot, what does each dot stand for?",
        isRequired: true,
        choices: [
          "An investment year",
          "An investable asset",
  ...
  model.onValidateQuestion.add(function (s, options) {
    if (options.name == "Dot_Instruction2") {
          ...
          <Grid container spacing={3}>
            <Grid item>
              ...
              <ul>
                ...
                <li>Each dot represents a possible rate of return.</li>
              </ul>
            </Grid>
            <Grid item>
              <h3>Example</h3>
...
export default InstructionsDot1;
